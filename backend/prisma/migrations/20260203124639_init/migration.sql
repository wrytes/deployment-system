...
-- CreateEnum
CREATE TYPE "ContainerStatus" AS ENUM ('CREATING', 'RUNNING', 'STOPPED', 'FAILED');
...
-- CreateIndex
CREATE UNIQUE INDEX "environments_public_domain_key" ON "environments"("public_domain");
...
-- CreateIndex
CREATE INDEX "containers_docker_id_idx" ON "containers"("docker_id");
